...
- Demo: **Portfolio Assets Finder** → https://youtu.be/MYZJR9mZTZ0  
- Demo: **NFL Betting Engine Case Study** → https://www.youtube.com/watch?v=xI88nChjKWU  
...
- 📄 **RAG PDF Assistant** — local PDF Q&A with source transparency + page citations  
  **Live:** https://mrponyrivers-rag-pdf-assistant.streamlit.app/  
...
- 📄 **Resume Extractor** — extract structured fields from PDF/TXT → JSON + Markdown report  
  **Live:** https://mrponyrivers-resume-extractor.streamlit.app/  
